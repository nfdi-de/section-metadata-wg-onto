...
| [FAIRagro](https://semantic.farm/collection/0000033)          | 23  | Gabriel Schneider                                        | [Add prefix to collection](https://github.com/biopragmatics/bioregistry/issues/new?template=add-collection-prefix.yml&collection=0000033&title=Add+prefix+X+to+FAIRagro)          |
...
| [NFDIxCS](https://semantic.farm/collection/0000035)           | 18  | Fabian Huch                                              | [Add prefix to collection](https://github.com/biopragmatics/bioregistry/issues/new?template=add-collection-prefix.yml&collection=0000035&title=Add+prefix+X+to+NFDIxCS)           |
...
| [Text+](https://semantic.farm/collection/0000038)             | 15  | Thorsten Trippel                                         | [Add prefix to collection](https://github.com/biopragmatics/bioregistry/issues/new?template=add-collection-prefix.yml&collection=0000038&title=Add+prefix+X+to+Text+)             |
