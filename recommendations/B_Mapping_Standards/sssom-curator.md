...
[SSSOM Curator](https://github.com/cthoyt/sssom-curator) is an open source project that combines:

1. A simple Python-based workflow for generating lexical mappings between ontologies, controlled vocabularies, and any other resource that mints identifiers
...
The tool was originally called [Biomappings](https://github.com/biopragmatics/biomappings), but was generalized and made domain-agnostic.
