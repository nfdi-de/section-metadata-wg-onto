...
A comprehensive list of tools for management of semantic artifacts is provided
by @Voss2025^[Online at <https://bartoc.org/software>.]. The list is not limited
to mapping tools but it excludes programming libraries such as SeMRA.
...
- coli-conc mapping registry / jskos-server

### KOS editors

Some generic KOS editors also allow to manage mappings from the semantic artifact being managed to other KOS. 
